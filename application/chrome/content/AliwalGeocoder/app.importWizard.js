...
function ImportWizard(){
	...
	this.importHeadings = function(){
		...
		this._headerCache = ret;
	
		return this._headerCache;
	}
	this.grabDelimiterSelection = function(){
		/* Privileged method */
		var ret = [];
	...
	this.grabLonLatSelections = function(){
	...
	this.grabDataSelections = function(){
		/* Puts selected column numbers - from importHeadings() - into impXXX.
		 */
	...
	this.grabTagSelections = function(){
		/* Puts selected column numbers - from importHeadings() - into impXXX.
		 */
	...
	this.grabLayoutSelection = function(){
		return 'delimited';
	}
	this.drawHeaderPreview = function(){
		try{
	...
	this.drawLonLatColumns = function(){
	...
	this.drawMoveListItem = function(pSourceListBoxId, pDestListBoxId ){
